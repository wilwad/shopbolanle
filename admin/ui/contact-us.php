<?php
  ...
  $fields = array(array('name'=>'full_name',
			      'caption'=>'Full Name',
                        'small'=>'',
                        'placeholder'=>'',
                        'type'=>'text',
	...
	if ($extra)	{
		...
		foreach($fields as $field){
			...
			if ($field['required'] == true && strlen($val) == 0){
				$errors = "<p class='alert alert-danger'>You forgot to specify <b>$name</b>, which is a required field.</p>
							  <script>
...
<div class="row" style="">
 <div class="col-md-12">
  <img src="Learner2.jpg" style='width:400px;' class="img-thumbnail" alt="Learners For You">
 </div>
</div>
-->
