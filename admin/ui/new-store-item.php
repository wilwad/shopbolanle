...
<?php
   ...
   $right_exists = verify_right($view);		
	...
	echo "<h4>$fa_file Create a store item
		...
		$scripts = "<script>
			...
			echo "<div class='col-md-8 border-right'>
			      <form class='form-horizontal' role='form' method='POST'  enctype='multipart/form-data'>
					<!-- required params start -->
						...
						<input type='hidden' name='returnurl'     value='?view=manage-store-items'>						
					...
					<div class='col-md-4'>
					 <h5>Notes</h5>
					 Add a new item you are selling in the store.
					</div>
