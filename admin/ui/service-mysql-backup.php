...
$dir  = dirname(__file__); // directory files
$name = 'backup'; // name sql backup
print_r( backup_database( $dir, $name, settings::db_host, 
									   settings::db_user, 
									   settings::db_pwd, 
									   settings::db_db) ); // execute
*/
 ...
 */
 ...
 function mysql_get_server_info_2(){
 	 global $database;
 	 
 	 $ret = $database->query("SELECT VERSION() as mysql_version");
 	 if (!$ret || !$ret->num_rows)
 	 {}
 	 else
 	 {
...
-- Server version: ".mysql_get_server_info_2()."
