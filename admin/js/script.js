...
var toggle_field = function(table, field, id, newval) {
	  BootstrapDialog.confirm('Are you sure you would like to perform this action?', function(ans){
		  if (ans){
		  	
		  	var data = {'view':'toggle-field', 
		  					'table': table, 
		  					'field': field, 
		  					'newval': newval,
		  					'id': id};
...
var delete_item = function(table, field, id) {
	  BootstrapDialog.confirm('Are you sure you would like to delete this ' + table +' record?', function(ans){
		  if (ans){
		  	
		  	var data = {'view':'deleteitem', 
		  					'table': table, 
		  					'field': field, 
		  					'id': id};
...
var clearDiv = function (divName) {
     document.getElementById(divName).innerHTML = "<p class='alert alert-info'><span class='fa fa-fw fa-info-circle'><span> <small>Ready.</small></p>";
}
		
var changeTitle = function () {
	 var currentTitle = $('#resultTitle').text();
    var newTitle = prompt(currentTitle);
    if (newTitle === null || newTitle === "")
    	return;
    	
    $('#resultTitle').text(newTitle); 
}
